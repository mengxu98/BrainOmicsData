...
SCIENCEDB_OUT_DIR="${SCIENCEDB_OUT_DIR:-/path/to/hpc/home/data/ScienceDB/HumanBrain_sc_snRNAseq_age_resource}"
...
RSCRIPT_DIR="${RSCRIPT_DIR:-/path/to/hpc/home/miniforge3/bin}"
