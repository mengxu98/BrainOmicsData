...
object_file <- normalizePath(
  value_after("--object-file", "/path/to/hpc/home/data/BrainOmicsData/integration/objects_celltypes.rds"),
  mustWork = TRUE
)
out_file <- value_after(
  "--out-file",
  "/path/to/hpc/home/data/ScienceDB/HumanBrain_sc_snRNAseq_age_resource/04_processed_objects/human_brain_integrated_full.h5ad"
)
